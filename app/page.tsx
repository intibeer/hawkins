        ...
        <div className="zen-container pt-8">
          <header className="mb-12 text-center">
            ...
            <p className="poppins-light text-base md:text-lg max-w-2xl mx-auto text-[#5d4037]/80">
              Explore the Map of Consciousness as described by Dr. David R. Hawkins.
              View the scale or take the free Hawkins Scale Test to discover your current level
              from lower states of fear to higher states of enlightenment.
            </p>
          </header>
